<template>
 <v-card >
    <v-layout>
      <v-navigation-drawer height="100vh" permanent v-model="drawer" temporary width="250"
    ...
    <v-layout>
      ...
      >
        <v-list color="transparent">
          ...
          <v-list-item prepend-icon="mdi-view-dashboard" > <router-link to="/productlist">Products List</router-link></v-list-item>

          <v-list-item prepend-icon="mdi-account-box"  ><router-link to="/userList">User List</router-link></v-list-item>
      ...
      <v-main style="height: 80vh"></v-main>
    </v-layout>
  </v-card>
